...
<%@ page import="ru.naumen.sd40.log.parser.datatypes.RenderDataType" %>
...
<%
    Number p50[] = (Number[])request.getAttribute(RenderDataType.PERCENTILE50);
    Number p99[] = (Number[])request.getAttribute(RenderDataType.PERCENTILE99);
    Number p100[] = (Number[])request.getAttribute(RenderDataType.MAX);
    Number count[]= (Number[])request.getAttribute(RenderDataType.COUNT);
    Number mean[]= (Number[])request.getAttribute(RenderDataType.MEAN);
    Number min[]= (Number[])request.getAttribute(RenderDataType.MIN);
